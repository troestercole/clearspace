    ...
    <div class="relative z-10 w-full max-w-md">
      ...
      >
        ...
        <div class="text-center mb-8">
          ...
          <h1 class="text-3xl font-bold text-gray-900 mb-2">Welcome to ClearSpace</h1>
        ...
        >
          ...
          <svg
            v-else
            class="w-5 h-5 animate-spin text-clearspace-primary"
            fill="none"
            viewBox="0 0 24 24"
          >
            <circle
        ...
        <div class="my-8 flex items-center">
          ...
          <span class="px-4 text-sm text-gray-500">Secure authentication</span>
          <div class="flex-1 border-t border-gray-200"></div>
        </div>
